...
public class ExerciseGetterSetter {
    ...
    public void setExercise_worked(String exercise_worked) {
        this.exercise_worked = exercise_worked;
    }
    ...
    public int getExercise_vid() {
        return exercise_vid;
    }

    public void setExercise_vid(int exercise_vid) {
